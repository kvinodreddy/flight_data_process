...
cities = [
    ...
    "Hickory", "Columbus", "Shreveport", "Bismarck", "Manchester", "Draper", "Peoria", 
    "Killeen", "Sioux Falls"
]
...
def generateFlightRecord():
    ...
    flight_duration_secs = random.randint(3600, 21600)
...
def generateFlightData(num_files=20, min_flights=50, max_flights=100):
    for _ in range(num_files):
        ...
        origin_city = random_flight["origin_city"] if random_flight["origin_city"] else "Unknown"
